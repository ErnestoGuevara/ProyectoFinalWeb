...
function NavBar() {
  return (
    ...
    <div className="container-fluid">
      ...
      <li className="nav-item">
        <a className="nav-link active" aria-current="page" href="/miercoles">
          Miercoles
        </a>
      </li>
      ...
      <li className="nav-item">
        <a className="nav-link active" aria-current="page" href="/viernes">
          Viernes
        </a>
      </li>
      ...
      <li className="nav-item">
        <a className="nav-link active" aria-current="page" href="/domingo">
          Domingo
        </a>
      </li>
        </ul>
